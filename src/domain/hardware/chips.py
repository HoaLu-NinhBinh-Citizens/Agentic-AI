...
CHIP_DEFINITIONS: dict[str, HardwareChip] = {
    ...
    "RP2040": HardwareChip(
        ...
        memory_map=[
            MemoryRegion(name="SRAM0", start=0x20000000, size=128*1024, type="SRAM"),
            MemoryRegion(name="SRAM1", start=0x20010000, size=128*1024, type="SRAM"),
            MemoryRegion(name="SRAM2", start=0x20020000, size=128*1024, type="SRAM"),
            MemoryRegion(name="SRAM3", start=0x20030000, size=128*1024, type="SRAM"),
        ],
        pin_count=40,
        package="QFN56",
    ),

...
- **MCP Protocol**: Filesystem, Git, Memory, Web servers
- **Git Integration**: Full git operations
- **Web Search**: DuckDuckGo, Tavily, SerpAPI, Brave
- **Plugin System**: Extension API + Marketplace
- **Collaboration**: WebSocket terminal sharing
